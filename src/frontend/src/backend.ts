...
export class Backend implements backendInterface {
    ...
    async addMachine(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: Array<MachinePart>): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deleteMGCRecord(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteMGCRecord(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllMGCRecords(): Promise<Array<MGCRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllMGCRecords();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllMachines(): Promise<Array<MachineRecord>> {
        if (this.processError) {
            try {
    ...
    async updateMachine(arg0: string, arg1: string, arg2: string, arg3: Array<MachinePart>): Promise<void> {
        if (this.processError) {
            try {
